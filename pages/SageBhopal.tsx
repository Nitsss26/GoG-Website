...
const SageBhopal = () => {
    ...
    const [applyRedirectUrl, setApplyRedirectUrl] = useState("https://admission.sageuniversity.edu.in/?utm_source=Website-Lead&utm_medium=Google&utm_campaign=Admissions-2024&_gl=1*f5pca6*_gcl_au*NjA5MjUwMTY4LjE3NzEwNzgwNTYuNjY0NjQyMzQuMTc3MTA3ODA1Ny4xNzcxMDc4MDY2");
    ...
    return (
        <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#34D562] selection:text-black overflow-x-hidden">
            ...
            <StickyNav
                onApplyClick={() => { setApplyRedirectUrl("https://admission.sageuniversity.edu.in/?utm_source=Website-Lead&utm_medium=Google&utm_campaign=Admissions-2024&_gl=1*f5pca6*_gcl_au*NjA5MjUwMTY4LjE3NzEwNzgwNTYuNjY0NjQyMzQuMTc3MTA3ODA1Ny4xNzcxMDc4MDY2"); setIsApplyOpen(true); }}
                logo={
                ...
                <div className="container mx-auto px-4 relative z-10 w-full max-w-7xl">
                    <div className="flex flex-col items-center text-center max-w-5xl mx-auto pt-28 md:pt-48 pb-12 md:pb-32">
                        ...
                        <motion.h1
                            ...
                            className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-tight md:leading-[0.9] mb-4 md:mb-6 tracking-tighter whitespace-nowrap"
                        >
                        ...
                        >
                            <button onClick={() => { setApplyRedirectUrl("https://admission.sageuniversity.edu.in/?utm_source=Website-Lead&utm_medium=Google&utm_campaign=Admissions-2024&_gl=1*f5pca6*_gcl_au*NjA5MjUwMTY4LjE3NzEwNzgwNTYuNjY0NjQyMzQuMTc3MTA3ODA1Ny4xNzcxMDc4MDY2"); setIsApplyOpen(true); }} className="flex-1 py-3 md:py-4 bg-[#34D562] text-black font-extrabold text-sm md:text-lg rounded-xl md:rounded-xl hover:bg-[#2dbd56] transition-all hover:scale-[1.02] shadow-[0_0_30px_rgba(52,213,98,0.3)] whitespace-nowrap">
                                Apply Now
                            </button>
                            <button
                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="mt-32">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-400 max-w-2xl mx-auto">Our program execution for the 2026 session to ensure direct industry exposure and prestigious certifications.</p>
                        </div>
                        <CurrentYearUpgrades />
                    </div>
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-20">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            {/* Fast Contact Card (Commented Out)
            ...
            <ChatBot universityName="SAGE University Bhopal" tuitionFee="₹1,30,000" />
        </div >
    );
};
