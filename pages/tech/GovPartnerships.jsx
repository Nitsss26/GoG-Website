...
const CyberOfficialCard = ({ image, name, designation, index, imageScale = 1, objectPosition = "top", className = "" }) => {
    return (
        <motion.div
            ...
            className={`group relative bg-[#020703]/80 backdrop-blur-md overflow-hidden border border-[#22ff66]/20 hover:border-[#22ff66]/80 transition-all duration-500 rounded-sm ${className}`}
        >
            {/* Cyber Grid Overlay */}
            ...
            {/* Text Content */}
            <div className="p-6 space-y-2 relative z-20 -mt-8">
                <h3 className="text-xl font-black text-white uppercase tracking-wider group-hover:text-[#22ff66] transition-colors duration-300">
                    {name}
                </h3>
            ...
            {/* Cyber Corners */}
            <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-[#22ff66]/50 opacity-0 group-hover:opacity-100 transition-all duration-500" />
            <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-[#22ff66]/50 opacity-0 group-hover:opacity-100 transition-all duration-500" />
            <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-[#22ff66]/50 opacity-0 group-hover:opacity-100 transition-all duration-500" />
            <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-[#22ff66]/50 opacity-0 group-hover:opacity-100 transition-all duration-500" />
        </motion.div>
    );
};
...
export default GovPartnerships;
