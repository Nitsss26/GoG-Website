...
import {
    rankings, mediaLinks, amenities,
    nearbyPlaces, curriculum, comparisonData,
    heroStats, admissionSteps, feeStructure,
    clubs, faqs, universityAbout,
    heroImages, campusHighlights
} from '../data/orientalData';

// Import assets
import GoGLogo from "../assets/gog-logo.png";
import {
    StudentVlogs, VirtualTour, ScholarshipStats, RecruiterTestimonials, BlogUpdates, ChatBot
...
const StackedCarousel = () => {
    ...
    const features = [
        ...
        { title: "Prestigious Certification", desc: "Degree from Oriental University.", icon: Award },
    ...
    return (
        <div className="relative h-[400px] w-full flex items-center justify-center overflow-hidden -my-16" style={{ perspective: "1200px" }}>
            {features.map((item, i) => {
...
const OrientalUniversity = () => {
    ...
    return (
        <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#34D562] selection:text-black overflow-x-hidden">
            <SEO
                title="BCA Artificial Intelligence & Data Science | Oriental University Indore"
                description="Apply for Oriental University Indore's industry-integrated BCA in Artificial Intelligence & Data Science. 100% placement support and curriculum designed by industry experts."
                canonical="/orientaluniversity"
            />
            ...
            <section className="relative min-h-[68vh] md:min-h-[110vh] lg:min-h-[115vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 w-full max-w-7xl">
                    <div className="flex flex-col items-center text-center max-w-5xl mx-auto pt-28 md:pt-48 pb-12 md:pb-32">
                        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="hidden md:inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-white/10 border border-white/20 mb-8 md:mb-12 backdrop-blur-md">
                        ...
                        <motion.h1 initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.1, duration: 0.8 }} className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-tight md:leading-[0.9] mb-6 md:mb-6 tracking-tighter whitespace-nowrap">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <div className="flex items-center gap-4 mb-6">
                                <img src={logoUrl} alt="Oriental University" className="h-16 w-auto rounded-2xl bg-white p-2" />
                                <div className="h-10 w-px bg-white/20" />
                                <span className="text-xl font-bold text-amber-400">UGC Approved University</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">The <span className="text-[#34D562]">First Private University</span> in Indore.</h2>
                            <p className="text-gray-400 mb-6 leading-relaxed text-lg">{universityAbout.vision}</p>
                        ...
                        <div className="relative">
                            <div className="relative py-8">
                                <div className="grid grid-cols-2 gap-4 w-full">
                                    {campusHighlights.slice(0, 4).map((img, idx) => (
                                        <div key={idx} className="rounded-2xl overflow-hidden border border-white/10 shadow-xl aspect-square relative group">
                                            <img src={img.src} alt={img.label} className="w-full h-full object-cover transform group-hover:scale-110 transition duration-700" />
                                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-80" />
                                            <div className="absolute bottom-3 left-3"><p className="text-white font-bold text-sm tracking-wide">{img.label}</p></div>
                                        </div>
                                    ))}
                                </div>
                            </div>
            ...
            <section className="py-16 bg-[#050505]">
                <div className="container mx-auto px-4 max-w-7xl">
                    <VirtualTour bgImage={heroImages[0]} tourUrl="https://admission.oui.edu.in/registration" />
                </div>
            </section>
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#111]/90 backdrop-blur-xl">
                            <div className="hidden md:grid grid-cols-12 border-b border-white/10 items-center bg-[#111]">
                                ...
                                <div className="col-span-4 text-[#34D562] font-bold text-lg p-6 bg-[#34D562]/10 border-x border-[#34D562]/20 relative flex items-center gap-6 justify-center">
                                    ...
                                    <div className="bg-white px-4 py-2 rounded-2xl shadow-xl border border-white/20 flex items-center justify-center h-14 w-32 shrink-0">
                                        <img src={logoUrl} className="h-full w-auto object-contain" alt="OUI" />
                                    </div>
                            ...
                            {comparisonData.map((row, i) => (
                                <div key={i} className="flex flex-col md:grid md:grid-cols-12 border-b border-white/5 last:border-0 items-stretch bg-[#111] md:bg-transparent">
                                    <div className="col-span-4 font-bold text-white p-4 md:p-6 flex items-center border-b md:border-b-0 border-white/5 bg-white/5 md:bg-transparent">{row.feature}</div>
                                    <div className="col-span-4 p-4 md:p-6 bg-[#34D562]/10 md:bg-[#34D562]/5 border-x border-[#34D562]/10 flex flex-col md:flex-row items-center justify-between gap-4 relative">
                                        <div className="md:hidden flex items-center gap-4 mb-6 border-b border-[#34D562]/10 pb-6 w-full justify-center">
                                            <div className="bg-white px-2 py-1 rounded-xl shadow-lg border border-white/10 flex items-center justify-center h-12 w-24 shrink-0"><img src={logoUrl} className="h-full w-auto object-contain" alt="OUI" /></div>
                                            <X size={16} className="text-gray-400 shrink-0" />
                                            <div className="bg-white px-1 py-1.5 rounded-xl shadow-lg border border-white/10 flex items-center justify-center h-12 w-24 shrink-0"><img src={GoGLogo} className="h-full w-auto object-contain" alt="GoG" /></div>
                                        </div>
                                        <div className="flex items-center justify-between w-full md:w-full gap-4">
                                            ...
                                            <div className="shrink-0 w-6 h-6 rounded-full border border-[#34D562] flex items-center justify-center text-[#34D562]"><Check size={14} strokeWidth={3} /></div>
                                        </div>
                                    </div>
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-20">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="flex-1 p-8 bg-[#0a0a0a] border border-white/10 rounded-3xl shadow-2xl relative group overflow-hidden flex flex-col">
                                ...
                                <div className="mt-6 pt-6 border-t border-white/10 relative z-10 flex-1 flex flex-col gap-6">
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-2">
                                            <div className="text-xs text-gray-400 flex items-center gap-2"><CheckCircle size={14} className="text-[#34D562]" /> Merit Scholarships</div>
                                            <div className="text-xs text-gray-400 flex items-center gap-2"><CheckCircle size={14} className="text-[#34D562]" /> Easy EMI Options</div>
                                            <div className="text-xs text-gray-400 flex items-center gap-2"><CheckCircle size={14} className="text-[#34D562]" /> Education Loans</div>
                                            <div className="text-xs text-gray-400 flex items-center gap-2"><CheckCircle size={14} className="text-[#34D562]" /> Early Bird Offers</div>
                                        </div>
                                    </div>
                                    <div className="mt-auto">
                                        ...
                                        <div className="mt-4 flex flex-wrap items-center justify-between gap-4 p-4 bg-white/5 border border-white/10 rounded-2xl shadow-xl relative overflow-hidden group">
                                            <div className="flex-1 min-w-[200px]">
                                                ...
                                                <p className="text-xs text-gray-300 leading-relaxed">Contact <span className="text-[#34D562] font-bold">+91 91524 72392</span> to know more about <span className="text-white font-semibold">Early Bird &amp; Merit</span>.</p>
                                            </div>
                                            <button onClick={() => setIsApplyOpen(true)} className="whitespace-nowrap px-6 py-2.5 text-xs font-bold bg-[#34D562] text-black rounded-full hover:bg-[#28a74b] shadow-[0_0_15px_rgba(52,213,98,0.3)]">Apply Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="placements" className="py-20 bg-[#020202] border-y border-white/5 relative overflow-hidden scroll-mt-[300px]">
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">Build Your <span className="text-[#34D562]">Dream Career.</span></h2>
                            <p className="text-gray-400 text-lg mb-8">Our 100% Placement Protection plan ensures you launch your career in top-tier product companies.</p>
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8">
                                <p className="text-gray-300 text-base leading-relaxed">Our students consistently secure positions at <span className="text-[#34D562] font-semibold">leading MNCs and Fortune 500 companies</span> with highly competitive salary packages. The industry-integrated curriculum, combined with intensive hands-on training and personalized mentorship, ensures that every graduate is <span className="text-white font-semibold">job-ready from Day 1</span>. With a proven track record of successful placements and strong recruiter relationships, your dream career is within reach.</p>
                            </div>
                            <button onClick={() => alert('Placement report will be available soon.')} className="flex items-center gap-2 px-6 py-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors text-white font-semibold w-fit"><Download size={18} /> Download Placement Report 2025</button>
                        </div>
                        <div className="bg-white p-8 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
                            <h4 className="text-black font-bold mb-6 flex items-center gap-2"><Briefcase className="text-[#34D562]" size={18} /> Top Recruiters</h4>
                            <div className="flex justify-center items-center"><img src="/assets/Gyanveer/recruiters_new.png" alt="Top Recruiters" className="w-full h-auto object-contain" /></div>
                            <div className="mt-6 text-center"><span className="inline-block px-4 py-2 text-[#34D562] font-bold text-sm bg-[#34D562]/10 rounded-full border border-[#34D562]/20">+ 190 More Companies</span></div>
                        </div>
                    </div>
                    {/* Industry Validation */}
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                        <div className="lg:w-1/4 flex lg:flex-col gap-1 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0 h-full">
                            {curriculum.map((sem, i) => (
                                <button key={i} onClick={() => setActiveSem(i)} className={`px-5 py-4 rounded-lg text-left font-medium transition-all whitespace-nowrap lg:whitespace-normal flex items-center justify-between group ${activeSem === i ? 'bg-[#34D562] text-black shadow-lg font-bold' : 'bg-[#111] text-gray-400 hover:bg-[#1a1a1a] border border-white/5'}`}>
                        ...
                        <div className="lg:w-3/4">
                            <AnimatePresence mode="wait">
                                <motion.div key={activeSem} initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} transition={{ duration: 0.2 }} className="bg-[#111] border border-white/10 rounded-2xl p-8 min-h-[400px] relative overflow-hidden">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 relative z-10 mb-8">
                                        <div className="space-y-4">
                                            <h4 className="flex items-center gap-2 text-white font-bold text-sm uppercase tracking-wider"><BookOpen size={16} className="text-[#34D562]" /> Core Subjects</h4>
                                            <div className="grid gap-2">
                                                {curriculum[activeSem].subjects.map((sub: any, i: number) => (
                                                    <div key={i} className="flex justify-between items-center p-3 bg-black/40 rounded border border-white/5 hover:border-[#34D562]/20 transition-colors">
                                                        <span className="text-gray-300 text-sm font-medium flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#34D562] shrink-0" />{sub.title}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                        <div className="space-y-6">
                                            <div className="space-y-4">
                                                <h4 className="flex items-center gap-2 text-white font-bold text-sm uppercase tracking-wider"><Code size={16} className="text-[#34D562]" /> Practical Labs</h4>
                                                <div className="grid gap-2">
                                                    {curriculum[activeSem].labs.map((lab: string, i: number) => (
                                                        <div key={i} className="flex items-center gap-3 p-3 bg-black/40 rounded border border-white/5 hover:bg-[#34D562]/5 transition-colors"><div className="w-1.5 h-1.5 rounded-full bg-[#34D562]" />{lab}</div>
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 bg-[#1a1a1a] rounded-xl border border-white/10 relative overflow-hidden group mt-4">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mt-12">
                        ...
                        <div className="p-6 bg-[#111] border border-white/5 rounded-2xl hover:border-[#34D562]/50 transition-colors group">
                            ...
                            <p className="text-gray-400 text-sm">Oriental University,</p>
                            <p className="text-gray-400 text-sm">Indore-Ujjain Road, Indore, MP</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <motion.div initial={{ scale: 0.7, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.7, opacity: 0 }} transition={{ type: "spring", damping: 25, stiffness: 300 }} className="relative w-[90%] md:w-[70%] lg:w-[60%] max-h-[85vh] bg-[#111] rounded-3xl overflow-hidden border border-[#34D562]/30 shadow-[0_0_80px_rgba(52,213,98,0.3)]" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="p-6 md:p-8">
                                <div className="flex items-center gap-4 mb-3">
                                    <div className="w-14 h-14 bg-[#34D562]/20 rounded-xl flex items-center justify-center text-[#34D562]"><selectedAmenity.icon size={28} /></div>
            ...
            <ChatBot universityName="Oriental University Indore" tuitionFee={feeStructure.tuitionPerYear} />
        </div>
    );
};

export default OrientalUniversity;
