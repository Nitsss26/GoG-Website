    ...
    const upgrades = [
        {
            ...
            desc: "Gain a massive competitive edge with a 3-month live internship directly under active Indian Institute of Technology (IIT) professors. Engage with elite faculty through immersive guided sessions.",
            status: "GAME CHANGER",
            icon: Laptop,
            color: "emerald",
            hex: "#34D562"
        ...
        {
            id: "02",
            title: "Active IIT Professor Interaction",
            subtitle: "Personalized Expert Guidance",
            desc: "Step beyond standard learning. Receive dedicated, personalized mentorship directly from Indian Institute of Technology (IIT) professors to dramatically accelerate your technical mastery and career readiness.",
            status: "UPGRADED",
            icon: Users,
            color: "blue",
            hex: "#3B82F6"
        ...
        },
        {
            ...
            desc: "Elevate your resume instantly. Upon completion of your internship, you earn a highly prestigious internship certificate officially signed by Indian Institute of Technology (IIT) professors.",
            status: "NEW",
            icon: Award,
            color: "yellow",
            hex: "#EAB308"
        ...
        },
        {
            ...
            desc: "Dominate the job market with the ultimate credential combo: GOG's presence on all your core academic records, alongside the signed  internship certificate.",
            status: "MAJOR USP",
            icon: Trophy,
            color: "cyan",
            hex: "#06B6D4"
