...
const About: React.FC = () => {
  const text = "Koii is a Decentralized Physical Infrastructure Network (DePIN). Koii Nodes, part of the Koii Network, generate passive rewards for node operators so that task operators can source data, storage, and compute from the nodes via microservices.";
