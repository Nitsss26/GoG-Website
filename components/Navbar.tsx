...
const Navbar: React.FC = () => {
  ...
  const isAdmissionsPage = ['/centurion', '/sagebhopal', '/gyanveer', '/sageindore', '/scope', '/orientaluniversity', '/ies-university'].includes(location.pathname);
            ...
            <Link to="/" className="flex items-center gap-2 cursor-pointer pointer-events-auto">
              {location.pathname === '/centurion' ? (
                <div className="flex items-center gap-1.5 md:gap-4 bg-white/95 backdrop-blur-sm px-2.5 py-1 md:px-4 md:py-2 rounded-full shadow-xl border border-white/20">
                  ...
                  <img src="https://res.cloudinary.com/dtkim5oeu/image/upload/v1780975214/u1di73fib4mijgih0hu9.png" alt="Geeks of Gurukul" className="h-6 md:h-6 object-contain" />
                </div>
              ...
              ) : location.pathname === '/ies-university' ? (
                <div className="flex items-center gap-1.5 md:gap-4 bg-white backdrop-blur-sm px-2.5 py-1 md:px-4 md:py-2 rounded-full shadow-xl border border-white/20">
                  <img src="https://cdn.prod.website-files.com/67fe6c64a51431b49c38a7bd/67fe6c64a51431b49c38abaa_WhatsApp%20Image%202024-11-28%20at%2017.46.46%20(1).webp" alt="IES University" className="h-6 md:h-8 object-contain" />
                  <span className="text-gray-400 font-bold text-[8px] md:text-sm">X</span>
                  <img src={GoGLogo} alt="Geeks of Gurukul" className="h-6 md:h-8 object-contain" />
                </div>
                ...
                <img src="https://res.cloudinary.com/dtkim5oeu/image/upload/v1780975214/u1di73fib4mijgih0hu9.png" alt="GoG Logo" className="h-8 md:h-10" />
              )}
            </Link>
